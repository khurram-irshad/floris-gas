      ...
      <div className="what-drive-us-container">
        ...
        <div className="what-drive-us-header">
          ...
          <p className="what-drive-us-description">
            We go the extra mile by offering reliable products, fair pricing,
            and exceptional
            <br />
            ...
            <div className="left-section">
              ...
              <div className="mission-content">
                ...
                <p className="mission-description">
                  Providing reliable and affordable propane solutions that power
                  homes, businesses, and communities across the region.
                </p>
              </div>
