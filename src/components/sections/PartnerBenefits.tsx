      ...
      <div className="partner-benefits-container">
        <div className="partner-benefits-content">
          <div className="partner-benefits-left">
            <h2 className="partner-benefits-title">Partner Benefits</h2>
            <p className="partner-benefits-description">
              When you partner with FloriGas, you&apos;re not just adding a
              product line – you&apos;re joining a comprehensive support system
            ...
            <div className="partner-image-container">
              ...
              <div className="stat-overlay satisfaction">
                ...
                <div className="stat-content">
                  <div className="stat-number-sell-propane">
