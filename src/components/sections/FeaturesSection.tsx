...
const featuresData = [
  ...
  },
  {
    ...
    title: "Better Value",
    description:
      "Take advantage of our competitive pricing, we work with any budget.",
  ...
  },
  {
    ...
    description:
      "Delivering reliable propane services with nearly three decades of proven excellence",
  ...
  },
  {
    ...
    description:
      "Skilled local professionals ensuring safe and on-time deliveries every day.",
