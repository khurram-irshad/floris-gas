            ...
            <div className="contact-info-section">
              ...
              <div className="contact-phones">
                <div className="phone-item">
                  ...
                  <span className="phone-number">(888) 814 0365</span>
                </div>
                <div className="phone-item">
                  <span className="phone-icon">📞</span>
                  <span className="phone-number">(305) 637 9262</span>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="form-group">
                ...
                >
                  ...
                  <option value="commercial">Commercial Propane</option>
                  <option value="emergency">Emergency Service</option>
                  <option value="delivery">Propane Delivery</option>
                  <option value="installation">Tank Installation</option>
                </select>
              </div>
