      ...
      <div className="case-study-container">
        <div className="case-study-content">
          ...
          <div className="case-study-right">
            ...
            <h2 className="case-study-title">Marina Bay Restaurant Group</h2>
            ...
            <div className="case-study-sections">
              <div className="case-study-item challenge">
                <div className="case-study-item-header">
                  ...
                  <h4 className="case-study-item-title challenge">
                    The Challenge
                  </h4>
                </div>
              ...
              <div className="case-study-item solution">
                <div className="case-study-item-header">
                  ...
                  <h4 className="case-study-item-title solution">
                    Our Solution
                  </h4>
                </div>
                <div className="case-study-item-content">
                  <p className="case-study-item-text">
                    ...
                    delivery scheduling, safety training, and 24/7 support
            ...
            <div className="case-study-testimonial">
              <div className="testimonial-content">
                <p className="testimonial-text">
                  ...
                  serving great food to our customers.&quot;
                </p>
