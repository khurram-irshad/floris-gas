...
const timelineData = [
  {
    ...
    fullDescription:
      "Started as a small family business with a single delivery truck, focused on providing reliable propane services to Central Florida communities.",
    image: "/Frame-1.jpg",
  },
  {
    id: 2,
    ...
    fullDescription:
      "Opened multiple distribution centers and expanded our delivery network to serve residential and commercial customers throughout the state.",
    image: "/Frame-2.jpg",
  },
  {
    id: 3,
    ...
    fullDescription:
      "Introduced 24/7 emergency service to ensure our customers never face propane shortages during critical times, setting new industry standards.",
    image: "/Frame-3.jpg",
  },
  {
    id: 4,
    ...
    fullDescription:
      "Introduced GPS tracking and automated scheduling systems to improve delivery efficiency and customer service.",
    image: "/Frame-4.jpg",
  },
  {
    id: 5,
    ...
    fullDescription:
      "Pioneered clean-burning propane technologies and sustainable delivery practices to reduce environmental impact.",
    image: "/Frame-5.jpg",
  },
  {
    id: 6,
    ...
    fullDescription:
      "Developed comprehensive digital platform allowing customers to schedule deliveries, monitor usage, and manage accounts online.",
    image: "/Frame-6.jpg",
  },
]
      ...
      <div className="success-story-container">
        ...
        <div className="success-story-header">
          ...
          <p className="success-story-description">
            At FloriGas Inc, we&apos;re your trusted full-service propane
            supplier in Florida. Backed by years
            <br />
            of expertise, we deliver reliable service with integrity, respect,
            and dedication.
          </p>
        </div>
                ...
                <div className="timeline-card">
                  ...
                  <div className="timeline-hover-overlay">
                    <div className="timeline-hover-text">
                      ...
                      <p className="timeline-hover-desc">
