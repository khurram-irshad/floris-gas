...
const industriesData = [
  {
    ...
    title:
      "High-performance propane solutions for commercial kitchens, grilling, and cooking operations with consistent heat and reliability.",
    image: "/C-kitchen.jpg",
    features: [
  ...
  },
  {
    ...
    title:
      "Power your agricultural operations with clean-burning propane for crop drying, irrigation, greenhouse heating, and equipment.",
    image: "/c-farmer.jpg",
    features: [
      "Crop drying systems",
      "Greenhouse heating",
  ...
  },
  {
    ...
    title:
      "Reliable propane for construction sites, warehouse heating, forklifts, and heavy equipment operations.",
  ...
  },
  {
    ...
    title:
      "Create exceptional guest experiences with propane for pool heating, outdoor kitchens, fire features, and backup power.",
    image: "/c-hotel.png",
    features: [
      "Pool & spa heating",
      ...
      <div className="industries-container">
        <div className="industries-header">
          ...
          <h2 className="industries-title">
            Specialized propane solutions tailored to meet the needs of various
            industries across Florida.
          </h2>
        </div>
